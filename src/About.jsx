...
function About() {
  return (
    <MainLayout>
      ...
      <iframe title={'About Us'} width={'100%'} height={600} src="https://www.youtube.com/embed/SwvAGEGRcoY" frameBorder={0} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
